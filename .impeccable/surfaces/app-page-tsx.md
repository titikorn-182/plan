...
OWN-WORLD: โต๊ะทำงานหลักฐานที่หนาแน่นและแม่นยำ ใช้สีส้มสถาบันกับพื้นขาว เส้นทะเบียน 1px คมชัด ปุ่มและพื้นผิวทรงเหลี่ยม ตัวอักษร Sarabun และสีสถานะที่มีป้ายหรือคำอธิบายกำกับเสมอ; ไม่มี gradient และไม่มีภาพตกแต่ง
