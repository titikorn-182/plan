      ...
      <section className="flex items-center justify-center bg-white px-6 py-12">
        <div className="w-full max-w-md">
          ...
          <p className="mt-2 text-sm leading-6 text-stone-500">
            ใช้อีเมลสถาบันและรหัสผ่านของคุณ ระบบจะแสดงข้อมูลตามบทบาทและหน่วยงานที่ได้รับสิทธิ์
          </p>
          {error ? (
            <p
              className="mt-5 border border-red-200 bg-red-50 px-3 py-2 text-xs text-red-800"
              role="alert"
            >
              {error === "inactive"
          ...
          <footer className="mt-8 border-t border-stone-200 pt-5 text-stone-500">
            <p className="text-xs leading-5">
              ระบบใช้ Supabase Auth และแสดงข้อมูลตามบทบาท ขอบเขตหน่วยงาน และรายการที่ได้รับมอบหมาย
            </p>
            <p className="mt-4 text-[11px] leading-5 text-stone-600">
              <span className="block">
                <strong className="font-semibold text-stone-700">พัฒนาโดย</strong> สำนักงานเลขานุการ
                คณะรัฐศาสตร์ มหาวิทยาลัยอุบลราชธานี
              </span>
              <span className="block">
                ฐิติกรณ์รัศมิ์ ภัททสิริภูวดล เจ้าหน้าที่บริหารงานทั่วไปชำนาญการพิเศษ
              </span>
            </p>
          </footer>
        </div>
      ...
      <section className="relative hidden overflow-hidden bg-[#c9440b] p-12 text-white lg:flex lg:flex-col lg:justify-between">
        ...
        <div className="relative max-w-2xl">
          <h2 className="text-5xl font-bold leading-[1.14] tracking-[-0.04em]">
            จากคำของบ
            <br />
            ถึงผลลัพธ์ที่ตรวจสอบได้
          </h2>
          <p className="mt-6 max-w-xl text-base leading-7 text-orange-50/85">
            ติดตามข้อเสนอโครงการ ความก้าวหน้า การเบิกจ่าย และ KPI บนสายข้อมูลเดียว
