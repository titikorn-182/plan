...
export function StatusPill({
  ...
  return (
    <span
      className={`inline-flex items-center gap-1 border px-2 py-1 text-[11px] font-semibold whitespace-nowrap ${tones[tone]}`}
    >
...
export function ProgressBar({
  ...
  return (
    <div
      ...
      aria-label={`ความก้าวหน้า ${value} เปอร์เซ็นต์`}
    >
      <span
